...
export async function getStaticPaths() {
  ...
  const pages = await builder.getAll("business-logged-in", {
...
export default function Page({ page }: { page: BuilderContent | null }) {
  ...
  return (
    <>
      ...
      <LayoutBusiness>
        <BuilderComponent model="business-logged-in" content={page || undefined} apiKey={API_KEY} />
      </LayoutBusiness>
    </>
  );
}